...
const uint16_t PROGMEM keymaps[3][MATRIX_ROWS2][MATRIX_COLS2] =
  {
	...
	LSFT(KC_H), LSFT(KC_T), LSFT(KC_Z),KC_NO, LSFT(KC_B),KC_NO,KC_NO,KC_NO, LSFT(KC_P),KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO },
	  ...
	  {KC_NO, KC_P,KC_P,KC_NO,KC_P,KC_NO,KC_NO,KC_NO,KC_P,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO, \
	  KC_P,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO},
