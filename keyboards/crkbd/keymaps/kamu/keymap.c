...
const uint16_t PROGMEM keymaps[3][MATRIX_ROWS2][MATRIX_COLS2] =
  {
	  {
	// ›››››
   	   { KC_NO, KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_ENTER,KC_NO,KC_NO,KC_NO, \
	   KC_NO,KC_NO,KC_NO,KC_NO, KC_SPACE,KC_NO,KC_NO,KC_NO, KC_BSPC,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO },
	// ››››œ
